...
// Tiene un menu con operaciones matematicas que se repiten hasta que el usuario le da al 7 
...
Proceso MiniCalculadora
	...
	Mientras op=1 | op=2 | op=3 | op=4 | op=5 | op=6 Hacer				// Mientras filtra las opciones del 1 al 6
		...
		si op>=1 y op<=6 Entonces										// Control de las opciones que poonga el usuario
			...
			Si op=1 Entonces											// 1º Opcion Suma
				...
				Escribir " "											
				Escribir "Menu"											
				op = CapturaOpcion()									// Llama a la funcion del menu 
						...
						SiNo
							...
							SiNo
								...
								Si op=6 Entonces						// 6º Opcion Ecuacion de 2º Grado
									...
									si b^2-4*a*c=0 Entonces 			// Comprobacion si lo que hay arriba en la raiz de la fracción da 0
